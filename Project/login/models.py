...
class LDAPGroup(ldapdb.models.Model):
    ...
    user_id = models.CharField(db_column='uid', primary_key=True, max_length=50)  # Field name made lowercase.
    user_name = models.CharField(db_column='givenName', max_length=50)  # Field name made lowercase.
    user_email = models.CharField(db_column='mail', max_length=320)  # Field name made lowercase.
    user_password = models.CharField(db_column='userPassword', max_length=100)  # Field name made lowercase.
    user_post = models.CharField(db_column='ou', max_length=100, blank=True, null=True)  # Field name made lowercase.
    user_office = models.SmallIntegerField(db_column='o')  # Field name made lowercase.
